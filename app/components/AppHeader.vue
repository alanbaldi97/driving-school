<template>
  <div class="w-full flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
    ...
    <div class="flex items-center space-x-3">
      ...
      <UButton
        :icon="props.sidebarOpen ? 'i-heroicons-chevron-left' : 'i-heroicons-chevron-right'"
        variant="ghost"
      ...
      />
      <div class="flex items-center space-x-3">
        <div class="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg ring-2 ring-white/20">
          <UIcon name="i-heroicons-home-modern" class="w-5 h-5 text-white" />
        </div>
        <h1 class="text-xl font-bold bg-gradient-to-r from-slate-800 to-indigo-600 dark:from-white dark:to-purple-200 bg-clip-text text-transparent">
          Dashboard
        </h1>
      </div>
    </div>
